...
import { reifyExpression, buildGap } from '@bablr/agast-vm-helpers';
      ...
      case 'advance': {
        ...
        switch (terminal.type) {
          ...
          case 'OpenNodeTag': {
            ...
            if (reference?.type !== 'Reference' && !(flags.trivia || flags.token))
              throw new Error();
